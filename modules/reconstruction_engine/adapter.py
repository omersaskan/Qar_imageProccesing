        ...
        with open(log_path, "a", encoding="utf-8") as log_file:
            ...
            try:
                ...
                try:
                    ...
                    if not mvs_project.exists():
                        raise
                    log_file.write("\nNote: InterfaceCOLMAP returned error but project.mvs exists. Continuing...\n")
                ...
                try:
                    ...
                    if not mvs_dense.exists():
                        raise
                    log_file.write("\nNote: DensifyPointCloud returned error but output exists. Continuing...\n")
