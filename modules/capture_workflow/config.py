...
class QualityThresholds(BaseModel):
    ...
    min_object_occupancy: float = Field(0.02, ge=0.0, le=1.0)
    max_object_occupancy: float = Field(0.90, ge=0.0, le=1.0)
    max_center_distance: float = Field(0.75, ge=0.0)
    min_mask_confidence: float = Field(0.30, ge=0.0, le=1.0)
    min_mask_purity: float = Field(0.30, ge=0.0, le=1.0)
    max_mask_fragments: int = Field(5, ge=1)
    min_dominant_contour_ratio: float = Field(0.60, ge=0.0, le=1.0)
    min_mask_solidity: float = Field(0.40, ge=0.0, le=1.0)
    max_border_touch_ratio: float = Field(0.50, ge=0.0, le=1.0)
