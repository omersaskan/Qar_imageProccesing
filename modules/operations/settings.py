...
class Settings(BaseSettings):
    ...
    hunyuan3d_21_model_path: str = Field("tencent/Hunyuan3D-2.1", validation_alias="HUNYUAN3D_21_MODEL_PATH")
    hunyuan3d_21_subfolder: str = Field("hunyuan3d-dit-v2-1", validation_alias="HUNYUAN3D_21_SUBFOLDER")
    hunyuan3d_21_texgen_model_path: str = Field("tencent/Hunyuan3D-2.1", validation_alias="HUNYUAN3D_21_TEXGEN_MODEL_PATH")
    hunyuan3d_21_mode: str = Field("shape_only", validation_alias="HUNYUAN3D_21_MODE")
    hunyuan3d_21_low_vram_mode: bool = Field(False, validation_alias="HUNYUAN3D_21_LOW_VRAM_MODE")
    hunyuan3d_21_texture_resolution: int = Field(512, validation_alias="HUNYUAN3D_21_TEXTURE_RESOLUTION")
    hunyuan3d_21_max_num_view: int = Field(6, validation_alias="HUNYUAN3D_21_MAX_NUM_VIEW")
    hunyuan3d_21_mock_runner: bool = Field(False, validation_alias="HUNYUAN3D_21_MOCK_RUNNER")
    # Legacy / existing backwards compatibility
    ...
    hunyuan3d_21_timeout_sec: int = Field(1800, validation_alias="HUNYUAN3D_21_TIMEOUT_SEC")
    ...
    ai_3d_quality_mode: str = Field("high", validation_alias="AI_3D_QUALITY_MODE")
    ai_3d_background_removal_enabled: bool = Field(True, validation_alias="AI_3D_BACKGROUND_REMOVAL_ENABLED")
